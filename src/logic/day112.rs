    ...
    pub fn run(&self) {
        ...
        loop {
            ...
            if line.starts_with("Monkey") {
                ...
                // Update mod number
                mod_number = mod_number * test_number;
        ...
        for _round in 0..10000 {
            ...
            for m in 0..num_monkeys {
                ...
                for throw in result {
                    monkey_list_ref.borrow_mut()[throw.0].catch_item(throw.1 % mod_number);
                }
            }
            // for m in 0..num_monkeys {
        ...
        // Print the result
        println!("Day 11 - Part 2: Result is {}", result);
    }
}