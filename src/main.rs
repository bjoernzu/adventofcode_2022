...
fn main() {
    ...
    puzzles.insert((21, 1), Box::new(logic::Day211));
    puzzles.insert((21, 2), Box::new(logic::Day212));
    puzzles.insert((22, 1), Box::new(logic::Day221));
    puzzles.insert((22, 2), Box::new(logic::Day222));
    puzzles.insert((23, 1), Box::new(logic::Day231));
    puzzles.insert((23, 2), Box::new(logic::Day232));
    puzzles.insert((24, 1), Box::new(logic::Day241));
    puzzles.insert((24, 2), Box::new(logic::Day242));
    puzzles.insert((25, 1), Box::new(logic::Day251));
    // puzzles.insert((25, 2), Box::new(logic::Day252));
